...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "qNJhn", function() { return qNJhn; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(0);
...
/**
 * @fileoverview Templates in namespace qNJhn.
 * @public
 */

goog.module('qNJhn.incrementaldom');
...
function $render(opt_data, opt_ignored, opt_ijData) {
  var param1227 = function() {
    ...
    ie_open('article', null, null,
      ...
      ie_open('div', null, null,
        ...
        ie_close('div');
      ie_close('div');
      $templateAlias2({code: '<button class="btn btn-info" data-target="#clayModalFullScreenSmDown" data-toggle="modal" type="button">Modal Full Screen Sm Down</button>\n<div aria-labelledby="clayModalFullScreenSmDownLabel" class="fade modal" id="clayModalFullScreenSmDown" role="dialog" tabindex="-1">\n    <div class="modal-dialog modal-full-screen-sm-down">\n        <div class="modal-content">\n            <div class="modal-header">\n                <div class="modal-title" id="clayModalFullScreenSmDownLabel">Modal Title</div>\n                <button aria-labelledby="Close" class="close" data-dismiss="modal" type="button">\n                    <svg aria-hidden="true" class="lexicon-icon lexicon-icon-times">\n                        <use xlink:href="/vendor/lexicon/icons.svg#times" />\n                    </svg>\n                </button>\n            </div>\n            <div class="modal-body">\n                <h4>Modal Body</h4>\n                <div>\n                    <p>\n                        Crema coffee a turkish decaffeinated espresso dripper cortado lungo con panna. Coffee, roast cup blue mountain beans single origin eu shop grounds caffeine a robusta. Sweet macchiato spoon, mug foam ut est ristretto.\n                    </p>\n                    <p>\n                        Irish coffee, at as cultivar robusta fair trade. Variety, caramelization, sweet, steamed, breve sit, whipped spoon at in caffeine. So latte, half and half, instant caf\u00E9 au lait whipped extra at percolator.\n                    </p>\n                    <p>\n                        Skinny extraction, viennese arabica aromatic robust kopi-luwak. Carajillo chicory dark espresso qui iced sugar. To go, at caf\u00E9 au lait chicory, qui, fair trade irish, beans seasonal extraction cappuccino kopi-luwak.\n                    </p>\n                    <p>\n                        Crema coffee a turkish decaffeinated espresso dripper cortado lungo con panna. Coffee, roast cup blue mountain beans single origin eu shop grounds caffeine a robusta. Sweet macchiato spoon, mug foam ut est ristretto.\n                    </p>\n                    <p>\n                        Irish coffee, at as cultivar robusta fair trade. Variety, caramelization, sweet, steamed, breve sit, whipped spoon at in caffeine. So latte, half and half, instant caf\u00E9 au lait whipped extra at percolator.\n                    </p>\n                </div>\n            </div>\n            <div class="modal-footer">\n                <button class="btn btn-secondary" data-dismiss="modal" type="button">Cancel</button>\n                <button class="btn btn-primary" type="button">Add</button>\n            </div>\n        </div>\n    </div>\n</div>', mode: 'text/html'}, null, opt_ijData);
    ie_close('article');
    ie_open('article', null, null,
        'id', 'clay-modal-configurations');
      ie_open('h3');
        itext('Configurations');
      ie_close('h3');
      ie_open('blockquote');
        ie_open('p');
          itext('Lexicon allows your modal window to have different configurations related to your needs. These needs vary from case to case and that is why not every modal in the system needs to be equal, but needs to follow certain rules.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('h4');
      ...
      ie_open('blockquote');
        ie_open('p');
          itext('It is always possible to bring an iFrame inside the body.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('blockquote');
        ie_open('p');
          ...
          ie_open('code');
            itext('modal-body');
          ie_close('code');
          itext(' helper class that sizes and styles an iframe nested inside modal-body. Add it to modal-body when you want the iframe to be the same width and height as modal-body.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('div', null, null,
      ...
      ie_open('div', null, null,
          ...
          'tabindex', '-1');
        ie_open('div', null, null,
            'class', 'modal-dialog modal-full-screen modal-full-screen-sm-down');
          ie_open('div', null, null,
              'class', 'modal-content');
            ie_open('div', null, null,
                'class', 'modal-header');
        ...
        ie_open('div', null, null,
          ...
          ie_open('div', null, null,
            ...
            ie_open('div', null, null,
              ...
              ie_open('div', null, null,
                  'class', 'modal-title',
                  'id', 'clayModalDangerLabel');
                ie_open('span', null, null,
                    'class', 'modal-title-indicator');
                  ie_open('svg', null, null,
                      'aria-hidden', 'true',
              ...
              ie_open('div', null, null,
                ...
                ie_open('span', null, null,
                  ...
                  ie_open('svg', null, null,
                    ...
                    ie_void('use', null, null,
                        'xlink:href', '/vendor/lexicon/icons.svg#check-circle-full');
                  ie_close('svg');
                ie_close('span');
                itext('Modal Title');
              ie_close('div');
              ...
              ie_open('div', null, null,
                ...
                ie_open('span', null, null,
                  ...
                  ie_open('svg', null, null,
                    ...
                    ie_void('use', null, null,
                        'xlink:href', '/vendor/lexicon/icons.svg#warning-full');
                  ie_close('svg');
                ie_close('span');
                itext('Modal Title');
              ie_close('div');
    ...
    ie_open('article', null, null,
      ...
      ie_open('blockquote');
        ie_open('p');
          ...
          itext(', and ');
          ie_open('code');
            itext('modal-item-last');
          ie_close('code');
          itext(' inside ');
          ie_open('code');
            itext('modal-footer');
          ie_close('code');
          itext(' to align content left, middle, and right.');
        ie_close('p');
      ie_close('blockquote');
    ie_close('article');
  ...
  $templateAlias1(soy.$$assignDefaults({content: param1227}, opt_data), null, opt_ijData);
}
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'qNJhn.render';
}
...
class qNJhn extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(qNJhn, templates);
...
var _modalsSoy = __webpack_require__(105);
...
var qNJhn = function (_Component) {
  _inherits(qNJhn, _Component);

  function qNJhn() {
    _classCallCheck(this, qNJhn);

    return _possibleConstructorReturn(this, (qNJhn.__proto__ || Object.getPrototypeOf(qNJhn)).apply(this, arguments));
  }
...
_metalSoy2.default.register(qNJhn, _modalsSoy2.default);

exports.default = qNJhn;
