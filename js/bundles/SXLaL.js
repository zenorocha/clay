...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SXLaL", function() { return SXLaL; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(0);
...
/**
 * @fileoverview Templates in namespace SXLaL.
 * @public
 */

goog.module('SXLaL.incrementaldom');
 ...
 */
function $render(opt_data, opt_ignored, opt_ijData) {
  var param1369 = function() {
    ie_open('article', null, null,
        'id', 'multi-step-nav-collapsed-sm');
      ie_open('h3');
        itext('Multi Step Nav Collapsed Sm');
      ie_close('h3');
      ie_open('div', null, null,
          'class', 'sheet');
        ie_open('ol', null, null,
          ...
          ie_open('li', null, null,
            ...
            ie_void('div', null, null,
                'class', 'multi-step-divider');
            ie_open('div', null, null,
                'class', 'dropdown multi-step-indicator');
              ie_open('div', null, null,
                  'class', 'multi-step-indicator-label');
                itext('Step 05');
              ie_close('div');
              ...
              ie_open('div', null, null,
                ...
                ie_open('a', null, null,
                    'class', 'active complete dropdown-item',
                    'href', '#1');
                  itext('5. Step Five');
                  ie_open('span', null, null,
                      'aria-hidden', 'true',
          ...
          ie_close('li');
          ie_open('li', null, null,
              'class', 'disabled multi-step-item multi-step-item-expand');
            ie_void('div', null, null,
                'class', 'multi-step-divider');
            ie_open('div', null, null,
                'class', 'multi-step-indicator');
  ...
  $templateAlias1(soy.$$assignDefaults({content: param1369}, opt_data), null, opt_ijData);
}
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'SXLaL.render';
}
...
class SXLaL extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(SXLaL, templates);
...
var _multi_step_navSoy = __webpack_require__(106);
...
var SXLaL = function (_Component) {
  _inherits(SXLaL, _Component);

  function SXLaL() {
    _classCallCheck(this, SXLaL);

    return _possibleConstructorReturn(this, (SXLaL.__proto__ || Object.getPrototypeOf(SXLaL)).apply(this, arguments));
  }
...
_metalSoy2.default.register(SXLaL, _multi_step_navSoy2.default);

exports.default = SXLaL;
