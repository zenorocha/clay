var pageComponent =
webpackJsonppageComponent([24,39,40],[
/* 0 */,
/* 1 */,
/* 2 */,
/* 3 */,
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "sKgzY", function() { return sKgzY; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(0);
...
/**
 * @fileoverview Templates in namespace sKgzY.
 * @public
 */

goog.module('sKgzY.incrementaldom');
...
function $render(opt_data, opt_ignored, opt_ijData) {
  var param957 = function() {
    ...
    ie_open('article', null, null,
      ...
      $templateAlias2({code: '<clay-icon spritemap="path/to/icons.svg" symbol="add-column"></clay-icon>\n\n<clay-icon spritemap="path/to/icons.svg" symbol="add-cell"></clay-icon>', mode: 'text/html'}, null, opt_ijData);
      ...
      ie_open('ul', null, null,
        ...
        var iconList985 = opt_data.page.icons;
        var iconListLen985 = iconList985.length;
        for (var iconIndex985 = 0; iconIndex985 < iconListLen985; iconIndex985++) {
          var iconData985 = iconList985[iconIndex985];
          ie_open('li');
            ie_open('svg', null, null,
                'class', 'lexicon-icon lexicon-icon-' + iconData985);
              ie_void('use', null, null,
                  'xlink:href', '/vendor/lexicon/icons.svg#' + iconData985);
            ie_close('svg');
            ie_open('span');
              var dyn22 = iconData985;
    ...
    ie_open('article', null, null,
      ...
      ie_open('ul', null, null,
          'class', 'lexicon-icon-list list-unstyled');
        var flagList997 = opt_data.page.flags;
        var flagListLen997 = flagList997.length;
        for (var flagIndex997 = 0; flagIndex997 < flagListLen997; flagIndex997++) {
          var flagData997 = flagList997[flagIndex997];
          ie_open('li');
            ie_open('svg', null, null,
                'class', 'lexicon-icon lexicon-icon-' + flagData997);
              ie_void('use', null, null,
                  'xlink:href', '/vendor/lexicon/icons.svg#' + flagData997);
            ie_close('svg');
            ie_open('span');
              var dyn23 = opt_data.page.flagData[flagData997];
              if (typeof dyn23 == 'function') dyn23(); else if (dyn23 != null) itext(dyn23);
              itext(' (');
              var dyn24 = flagData997;
  ...
  $templateAlias1(soy.$$assignDefaults({content: param957}, opt_data), null, opt_ijData);
}
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'sKgzY.render';
}
...
class sKgzY extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(sKgzY, templates);
...
var _iconsLexiconSoy = __webpack_require__(106);
...
var sKgzY = function (_Component) {
  _inherits(sKgzY, _Component);

  function sKgzY() {
    _classCallCheck(this, sKgzY);

    return _possibleConstructorReturn(this, (sKgzY.__proto__ || Object.getPrototypeOf(sKgzY)).apply(this, arguments));
  }
...
_metalSoy2.default.register(sKgzY, _iconsLexiconSoy2.default);

exports.default = sKgzY;
