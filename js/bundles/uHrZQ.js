...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "uHrZQ", function() { return uHrZQ; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(0);
...
/**
 * @fileoverview Templates in namespace uHrZQ.
 * @public
 */

goog.module('uHrZQ.incrementaldom');
...
function $render(opt_data, opt_ignored, opt_ijData) {
  var param949 = function() {
    ...
    ie_open('article', null, null,
      ...
      ie_open('ul', null, null,
        ...
        var iconList977 = opt_data.page.icons;
        var iconListLen977 = iconList977.length;
        for (var iconIndex977 = 0; iconIndex977 < iconListLen977; iconIndex977++) {
          var iconData977 = iconList977[iconIndex977];
          ie_open('li');
            ie_open('svg', null, null,
                'class', 'lexicon-icon lexicon-icon-' + iconData977);
              ie_void('use', null, null,
                  'xlink:href', '/vendor/lexicon/icons.svg#' + iconData977);
            ie_close('svg');
            ie_open('span');
              var dyn22 = iconData977;
    ...
    ie_open('article', null, null,
      ...
      ie_open('ul', null, null,
          'class', 'lexicon-icon-list list-unstyled');
        var flagList989 = opt_data.page.flags;
        var flagListLen989 = flagList989.length;
        for (var flagIndex989 = 0; flagIndex989 < flagListLen989; flagIndex989++) {
          var flagData989 = flagList989[flagIndex989];
          ie_open('li');
            ie_open('svg', null, null,
                'class', 'lexicon-icon lexicon-icon-' + flagData989);
              ie_void('use', null, null,
                  'xlink:href', '/vendor/lexicon/icons.svg#' + flagData989);
            ie_close('svg');
            ie_open('span');
              var dyn23 = opt_data.page.flagData[flagData989];
              if (typeof dyn23 == 'function') dyn23(); else if (dyn23 != null) itext(dyn23);
              itext(' (');
              var dyn24 = flagData989;
  ...
  $templateAlias1(soy.$$assignDefaults({content: param949}, opt_data), null, opt_ijData);
}
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'uHrZQ.render';
}
...
class uHrZQ extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(uHrZQ, templates);
...
var _iconsLexiconSoy = __webpack_require__(99);
...
var uHrZQ = function (_Component) {
  _inherits(uHrZQ, _Component);

  function uHrZQ() {
    _classCallCheck(this, uHrZQ);

    return _possibleConstructorReturn(this, (uHrZQ.__proto__ || Object.getPrototypeOf(uHrZQ)).apply(this, arguments));
  }
...
_metalSoy2.default.register(uHrZQ, _iconsLexiconSoy2.default);

exports.default = uHrZQ;
