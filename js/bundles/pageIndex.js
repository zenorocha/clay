      ...
      ie_open('div', null, null,
        ...
        ie_open('div', null, null,
          ...
          ie_open('div', null, null,
            ...
            ie_close('h2');
            ie_open('a', null, null,
                'class', 'btn btn-lg btn-light font-weight-bold mx-3 mb-4',
                'href', '/docs/clay/');
              itext('Get Started');
            ie_close('a');
            ie_open('a', null, null,
          ...
          ie_open('div', null, null,
            ...
            ie_open('div', null, null,
              ...
              ie_open('div', null, null,
                ...
                ie_open('div', null, null,
                    'class', 'card-body mx-4 pl-md-0 pt-5');
                  ie_open('h2', null, null,
                      'class', 'font-weight-bold');
    ...
    ie_open('div', null, null,
      ...
      ie_open('div', null, null,
        ...
        ie_open('div', null, null,
          ...
          ie_open('p', null, null,
              'class', 'pb-5 pt-4');
            itext('There\'s always been a distinction between Lexicon as a design system, and Lexicon as a web implementation. Naming them like this didn\'t help with the distinction, so ');
            ie_open('span', null, null,
                'class', 'font-weight-bold');
              itext('the web implementation of Lexicon is now called Clay');
            ie_close('span');
            itext('.');
          ie_close('p');
        ie_close('div');
