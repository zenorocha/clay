...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "mozcO", function() { return mozcO; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(0);
...
/**
 * @fileoverview Templates in namespace mozcO.
 * @public
 */

goog.module('mozcO.incrementaldom');
...
function $render(opt_data, opt_ignored, opt_ijData) {
  var param508 = function() {
    ...
    ie_open('article', null, null,
      ...
      ie_open('blockquote');
        ie_open('p');
          itext('Used in image/document galleries.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('h4');
        itext('Default');
      ...
      ie_open('div', null, null,
        ...
        ie_open('div', null, null,
            'class', 'col-md-4');
          ie_open('div', null, null,
              'class', 'active card-type-asset form-check form-check-card form-check-top-left image-card');
            ie_open('div', null, null,
                'class', 'card');
              ie_open('div', null, null,
                  'class', 'aspect-ratio card-item-first');
      ...
      $templateAlias2({code: '{call ClayImageCard.render}\n    {param actionItems: [\n        [\n            \'href\': \'#1\',\n            \'label\': \'Edit\',\n            \'separator\': true\n        ],\n        [\n            \'href\': \'#1\',\n            \'label\': \'Save\'\n        ]\n    ] /}\n    {param fileType: \'JPG\' /}\n    {param fileTypeStyle: \'danger\' /}\n    {param imageAlt: \'thumbnail\' /}\n    {param imageSrc: \'/images/thumbnail_coffee.jpg\' /}\n    {param labels: [\n        [\n            \'label\': \'Approved\',\n            \'style\': \'success\'\n        ]\n    ] /}\n    {param selectable: true /}\n    {param selected: true /}\n    {param spritemap: \'/vendor/lexicon/icons.svg\' /}\n    {param subtitle: \'Author Action\' /}\n    {param title: \'thumbnail_coffee.jpg\' /}\n{/call}', mode: 'soy'}, null, opt_ijData);
      $templateAlias2({code: '<clay-image-card\n    actionItems=\'[{"href": "#1", "label": "Edit", "separator": true}, {"href": "#1", "label": "Save"}]\'\n    fileType="JPG"\n    fileTypeStyle="danger"\n    imageAlt="thumbnail"\n    imageSrc="/images/thumbnail_coffee.jpg"\n    labels=\'[{"label": "Approved", "style": "success"}]\'\n    selectable="true"\n    selected="true"\n    spritemap="/vendor/lexicon/icons.svg"\n    subtitle="Author Action"\n    title="thumbnail_coffee.jpg">\n</clay-image-card>', mode: 'text/html'}, null, opt_ijData);
      $templateAlias2({code: '<div class="active card-type-asset form-check form-check-card form-check-top-left image-card">\n    <div class="card">\n        <div class="aspect-ratio card-item-first">\n            <div class="custom-control custom-checkbox">\n                <label>\n                    <input class="custom-control-input" type="checkbox" checked="true">\n                    <span class="custom-control-label"></span>\n                    <img alt="thumbnail"class="aspect-ratio-item-center-middle aspect-ratio-item-fluid" src="/images/thumbnail_coffee.jpg">\n                    <span class="sticker sticker-bottom-left sticker-danger">JPG</span>\n                </label>\n            </div>\n        </div>\n        <div class="card-body">\n            <div class="card-row">\n                <div class="autofit-col autofit-col-expand">\n                    <div class="card-title text-truncate" title="thumbnail_coffee.jpg">thumbnail_coffee.jpg</div>\n                    <div class="card-subtitle text-truncate" title="Author Action">Author Action</div>\n                    <div class="card-detail">\n                        <span class="label label-success">Approved</span>\n                    </div>\n                </div>\n                <div class="autofit-col">\n                    <div class="dropdown dropdown-action">\n                        <a aria-expanded="false" aria-haspopup="true" class="dropdown-toggle" data-toggle="dropdown" href="#1" role="button">\n                            <svg aria-hidden="true" class="lexicon-icon lexicon-icon-ellipsis-v">\n                                <use xlink:href="/vendor/lexicon/icons.svg#ellipsis-v" />\n                            </svg>\n                        </a>\n                        <div class="dropdown-menu dropdown-menu-right">\n                            <a class="dropdown-item" href="#1">Download</a>\n                            <a class="dropdown-item" href="#1">Edit</a>\n                            <a class="dropdown-item" href="#1">Move</a>\n                            <a class="dropdown-item" href="#1">Checkout</a>\n                            <a class="dropdown-item" href="#1">Permissions</a>\n                            <a class="dropdown-item" href="#1">Move to Recycle Bin</a>\n                        </div>\n                    </div>\n                </div>\n            </div>\n        </div>\n    </div>\n</div>', mode: 'text/html'}, null, opt_ijData);
      ie_open('h4');
        itext('Empty');
      ie_close('h4');
      ie_open('div', null, null,
        ...
        ie_open('div', null, null,
          ...
          ie_open('div', null, null,
            ...
            ie_open('div', null, null,
                'class', 'aspect-ratio card-item-first');
              ie_open('span', null, null,
                  'class', 'sticker sticker-bottom-left sticker-info');
                itext('PNG');
              ie_close('span');
            ie_close('div');
            ie_open('div', null, null,
      ...
      $templateAlias2({code: '<div class="card card-type-asset image-card">\n    <div class="aspect-ratio card-item-first">\n        <span class="sticker sticker-bottom-left sticker-info">PNG</span>\n    </div>\n    <div class="card-body">\n        <div class="card-row">\n            <div class="autofit-col autofit-col-expand">\n                <div class="card-title text-truncate" title="empty-background.png">empty-background.png</div>\n                <div class="card-subtitle text-truncate" title="Author Action">Author Action</div>\n                <div class="card-detail">\n                    <span class="label label-danger">Rejected</span>\n                </div>\n            </div>\n            <div class="autofit-col">\n                <div class="dropdown dropdown-action">\n                    <a aria-expanded="false" aria-haspopup="true" class="dropdown-toggle" data-toggle="dropdown" href="#1" role="button">\n                        <svg aria-hidden="true" class="lexicon-icon lexicon-icon-ellipsis-v">\n                            <use xlink:href="/vendor/lexicon/icons.svg#ellipsis-v" />\n                        </svg>\n                    </a>\n                    <div class="dropdown-menu dropdown-menu-right">\n                        <a class="dropdown-item" href="#1">Download</a>\n                        <a class="dropdown-item" href="#1">Edit</a>\n                        <a class="dropdown-item" href="#1">Move</a>\n                        <a class="dropdown-item" href="#1">Checkout</a>\n                        <a class="dropdown-item" href="#1">Permissions</a>\n                        <a class="dropdown-item" href="#1">Move to Recycle Bin</a>\n                    </div>\n                </div>\n            </div>\n        </div>\n    </div>\n</div>', mode: 'text/html'}, null, opt_ijData);
      ie_open('h4');
        itext('IMAGE WITH DIFFERENT RATIOS');
      ie_close('h4');
      ie_open('blockquote');
        ie_open('p');
          itext('It is important to highlight that images can have different sizes. To provide the end user with that relevant data about the image Lexicon incorporates cards that allow this feature.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('div', null, null,
          'class', 'row');
                ...
                ie_open('div', null, null,
                  ...
                  ie_open('label');
                    ...
                    ie_void('span', null, null,
                        'class', 'custom-control-label');
                    ie_open('div', null, null,
                        'class', 'aspect-ratio-item-center-middle aspect-ratio-item-fluid card-type-asset-icon');
                      ie_open('svg', null, null,
                          'aria-hidden', 'true',
                ...
                ie_open('div', null, null,
                  ...
                  ie_open('div', null, null,
                    ...
                    ie_open('div', null, null,
                      ...
                      itext('lexicon_icon_camera_av93ii2oofffmmmsjf2332.svg');
                    ie_close('div');
                    ie_open('div', null, null,
                        'class', 'card-subtitle text-truncate',
                        'title', 'Author Action');
    ...
    ie_open('article', null, null,
      ...
      ie_open('blockquote');
        ie_open('p');
          itext('User card is used to represent users. The user can be represented by its user image or up to two initials extracted from the uses name or name + surname.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('div', null, null,
          'class', 'row');
    ...
    ie_open('article', null, null,
      ...
      ie_open('blockquote');
        ie_open('p');
          itext('File card is used to represent files different to images.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('div', null, null,
          'class', 'row');
            ...
            ie_open('div', null, null,
              ...
              ie_open('div', null, null,
                ...
                ie_open('svg', null, null,
                  ...
                  ie_void('use', null, null,
                      'xlink:href', '/vendor/lexicon/icons.svg#documents-and-media');
                ie_close('svg');
              ie_close('div');
              ie_open('span', null, null,
                  'class', 'sticker sticker-bottom-left sticker-danger');
        ...
        ie_open('div', null, null,
            'class', 'col-md-4');
          ie_open('div', null, null,
              'class', 'card-type-asset form-check form-check-card form-check-top-left file-card');
            ie_open('div', null, null,
                'class', 'card');
              ie_open('div', null, null,
                  'class', 'aspect-ratio card-item-first');
...
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'mozcO.render';
}
...
class mozcO extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(mozcO, templates);
...
var _cardsSoy = __webpack_require__(92);
...
var mozcO = function (_Component) {
  _inherits(mozcO, _Component);

  function mozcO() {
    _classCallCheck(this, mozcO);

    return _possibleConstructorReturn(this, (mozcO.__proto__ || Object.getPrototypeOf(mozcO)).apply(this, arguments));
  }
...
_metalSoy2.default.register(mozcO, _cardsSoy2.default);

exports.default = mozcO;
