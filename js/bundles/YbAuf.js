...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "YbAuf", function() { return YbAuf; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(0);
...
/**
 * @fileoverview Templates in namespace YbAuf.
 * @public
 */

goog.module('YbAuf.incrementaldom');
...
function $render(opt_data, opt_ignored, opt_ijData) {
  var param614 = function() {
    ...
    ie_open('article', null, null,
      ...
      $templateAlias2({code: '<div aria-labelledby="theDropdownToggleId" class="dropdown-menu">\n    <a class="active dropdown-item" href="#">Selected Option</a>\n    <a class="dropdown-item" href="#">Normal Option</a>\n    <a class="disabled dropdown-item" href="#">Disabled Option</a>\n</div>', mode: 'text/html'}, null, opt_ijData);
      ie_open('h4');
        itext('Dropdown with dividers');
      ie_close('h4');
      ie_open('blockquote');
        ie_open('p');
          itext('Dropdown menu with dividers are thought to be used in actions menus. Dividing the actions by context of use help users to find actions.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('div', null, null,
          'class', 'clay-site-dropdown-menu-container');
      ...
      ie_open('h4');
        itext('Dropdown with Checkbox or Radio');
      ie_close('h4');
      ie_open('blockquote');
        ie_open('p');
          itext('Dropdowns can be configured to have checkboxes and/or radio groups. A checkbox configuration can be suitable to filter in or out dataset elements. While, a radio configuration can be suitable to establish the order criteria in a dataset.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('div', null, null,
          'class', 'clay-site-dropdown-menu-container');
      ...
      ie_open('h4');
        itext('Dropdown with search field');
      ie_close('h4');
      ie_open('blockquote');
        ie_open('p');
          itext('Sometimes action menus face problems with the number of elements they contain. This dropdown menu variation helps in those contexts where the set of options is large and a search mechanism helps to reduce the search time and task complexity.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('div', null, null,
          'class', 'clay-site-dropdown-menu-container');
      ...
      ie_open('h4');
        itext('Dropdown with left icons');
      ie_close('h4');
      ie_open('blockquote');
        ie_open('p');
          itext('Dropdown menus with left icons are suitable for process bars (wizards) where there is a need to display a dropdown menu when the number of steps do not fit the screen.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('div', null, null,
          'class', 'clay-site-dropdown-menu-container');
      ...
      $templateAlias2({code: '<div aria-labelledby="theDropdownToggleId" class="dropdown-menu dropdown-menu-indicator-start">\n    <a class="dropdown-item" href="#1">\n        <div class="dropdown-item-indicator">\n            <svg aria-hidden="true" class="lexicon-icon lexicon-icon-check">\n                <use xlink:href="/vendor/lexicon/icons.svg#check" />\n            </svg>\n        </div>\n        Normal Option\n    </a>\n    <a class="dropdown-item" href="#1">\n        <div class="dropdown-item-indicator">\n            <svg aria-hidden="true" class="lexicon-icon lexicon-icon-check">\n                <use xlink:href="/vendor/lexicon/icons.svg#check" />\n            </svg>\n        </div>\n        Second Option\n    </a>\n    <a class="disabled dropdown-item" href="#1">Disabled Option</a>\n</div>', mode: 'text/html'}, null, opt_ijData);
      ie_open('h4');
        itext('Dropdown with right icons');
      ie_close('h4');
      ie_open('blockquote');
        ie_open('p');
          itext('Dropdown menus with left icons are suitable for process bars (wizards) where there is a need to display a dropdown menu when the number of steps do not fit the screen. In this case, the step number has a high relevance, therefore the icon is placed on the right side.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('div', null, null,
          'class', 'clay-site-dropdown-menu-container');
      ...
      $templateAlias2({code: '<div aria-labelledby="theDropdownToggleId" class="dropdown-menu dropdown-menu-indicator-end">\n    <a class="active dropdown-item" href="#1">\n        Selected Option\n        <div class="dropdown-item-indicator">\n            <svg aria-hidden="true" class="lexicon-icon lexicon-icon-check">\n                <use xlink:href="/vendor/lexicon/icons.svg#check" />\n            </svg>\n        </div>\n    </a>\n    <a class="dropdown-item" href="#1">\n        Regular Option\n        <div class="dropdown-item-indicator">\n            <svg aria-hidden="true" class="lexicon-icon lexicon-icon-check">\n                <use xlink:href="/vendor/lexicon/icons.svg#check" />\n            </svg>\n        </div>\n    </a>\n    <a class="disabled dropdown-item" href="#1">Disabled Option</a>\n</div>', mode: 'text/html'}, null, opt_ijData);
      ie_open('h4');
        itext('Dropdown with groups');
      ie_close('h4');
      ie_open('blockquote');
        ie_open('p');
          itext('This dropdown menu variation is created to be used with the management bar Filter and Order dropdown button. This configuration is thought to clean the management bar providing the user with more specific mechanisms to find data.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('blockquote');
        ie_open('p');
          itext('The button in a dropdown menu can be either primary or secondary depending on the application needs.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('div', null, null,
          'class', 'clay-site-dropdown-menu-container');
    ...
    ie_close('article');
    ie_open('article', null, null,
        'id', 'clay-dropdown-sorting-actions');
      ie_open('h3');
        itext('Sorting actions');
      ie_close('h3');
      ie_open('h4');
        itext('Dropdown menu from actions button');
      ie_close('h4');
      ie_open('blockquote');
        ie_open('p');
          itext('A monospaced ');
      ...
      ie_open('div', null, null,
        ...
        ie_close('div');
      ie_close('div');
      $templateAlias2({code: '{call ClayActionsDropdown.render}\n    {param items: [\n        [\n            \'href\': \'#1\',\n            \'label\': \'Edit\'\n        ],\n        [\n            \'href\': \'#1\',\n            \'label\': \'Preview\',\n            \'separator\': true\n        ],\n        [\n            \'href\': \'#1\',\n            \'label\': \'Expire\'\n        ],\n        [\n            \'href\': \'#1\',\n            \'label\': \'View History\',\n            \'separator\': true\n        ],\n        [\n            \'href\': \'#1\',\n            \'label\': \'Permissions\',\n            \'separator\': true\n        ],\n        [\n            \'href\': \'#1\',\n            \'label\': \'Copy\'\n        ],\n        [\n            \'href\': \'#1\',\n            \'label\': \'Move\',\n            \'separator\': true\n        ],\n        [\n            \'href\': \'#1\',\n            \'label\': \'Move to Recycle Bin\'\n        ]\n    ] /}\n    {param spritemap: \'/vendor/lexicon/icons.svg\' /}\n{/call}', mode: 'soy'}, null, opt_ijData);
      $templateAlias2({code: '<clay-dropdown\n    items=\'[{"href": "#", "label": "Edit"}, {"href": "#", "label": "Preview", "separator": true}, {"href": "#", "label": "Expire"}, {"href": "#", "label": "View History", "separator": true}, {"href": "#", "label": "Permissions", "separator": true}, {"href": "#", "label": "Copy"}, {"href": "#", "label": "Move", "separator": true}, {"href": "#", "label": "Move to Recycle Bin"}]\'\n    spritemap="/vendor/lexicon/icons.svg"\n</clay-dropdown>', mode: 'text/html'}, null, opt_ijData);
      $templateAlias2({code: '<div aria-labelledby="theDropdownToggleId" class="dropdown-menu">\n    <a class="dropdown-item" href="#1">Edit</a>\n    <a class="dropdown-item" href="#2">Preview</a>\n    <div class="dro pdown-divider"></div>\n    <a class="dropdown-item" href="#3">Expire</a>\n    <a class="dropdown-item" href="#4">View History</a>\n    <div class="dropdown-divider"></div>\n    <a class="dropdown-item" href="#5">Permissions</a>\n    <div class="dropdown-divider"></div>\n    <a class="dropdown-item" href="#6">Copy</a>\n    <a class="dropdown-item" href="#7">Move</a>\n    <div class="dropdown-divider"></div>\n    <a class="dropdown-item" href="#8">Move to Recycle Bin</a>\n</div>', mode: 'text/html'}, null, opt_ijData);
      ie_open('h4');
        itext('Dropdown menu from plus button');
      ie_close('h4');
      ie_open('div', null, null,
          'class', 'clay-site-dropdown-menu-container');
        ie_open('ul', null, null,
...
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'YbAuf.render';
}
...
class YbAuf extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(YbAuf, templates);
...
var _dropdownsSoy = __webpack_require__(93);
...
var YbAuf = function (_Component) {
  _inherits(YbAuf, _Component);

  function YbAuf() {
    _classCallCheck(this, YbAuf);

    return _possibleConstructorReturn(this, (YbAuf.__proto__ || Object.getPrototypeOf(YbAuf)).apply(this, arguments));
  }
...
_metalSoy2.default.register(YbAuf, _dropdownsSoy2.default);

exports.default = YbAuf;
