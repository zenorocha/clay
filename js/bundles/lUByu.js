var pageComponent =
webpackJsonppageComponent([25,39,40],[
/* 0 */,
/* 1 */,
/* 2 */,
/* 3 */,
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "lUByu", function() { return lUByu; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(0);
...
/**
 * @fileoverview Templates in namespace lUByu.
 * @public
 */

goog.module('lUByu.incrementaldom');
 ...
 */
function $render(opt_data, opt_ignored, opt_ijData) {
  var param943 = function() {
    ie_open('article', null, null,
        'id', 'navbar-application-bar');
      ie_open('h3');
        itext('Header');
      ie_close('h3');
      ie_open('p');
        ie_open('nav', null, null,
            'class', 'application-bar application-bar-dark navbar navbar-expand-md');
          ie_open('div', null, null,
              'class', 'container');
            ie_open('ul', null, null,
                'class', 'navbar-nav');
            ...
            ie_close('ul');
            ie_open('div', null, null,
                'class', 'navbar-title navbar-text-truncate');
              itext('My Application Name');
            ie_close('div');
            ie_open('ul', null, null,
                'class', 'navbar-nav');
              ie_open('li', null, null,
              ...
              ie_open('li', null, null,
                ...
                ie_open('a', null, null,
                  ...
                  ie_open('svg', null, null,
                    ...
                    ie_void('use', null, null,
                        'xlink:href', '/vendor/lexicon/icons.svg#simulation-menu-closed');
                  ie_close('svg');
                ie_close('a');
              ie_close('li');
              ie_open('li', null, null,
  ...
  $templateAlias1(soy.$$assignDefaults({content: param943}, opt_data), null, opt_ijData);
}
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'lUByu.render';
}
...
class lUByu extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(lUByu, templates);
...
var _headerSoy = __webpack_require__(105);

var _headerSoy2 = _interopRequireDefault(_headerSoy);
...
var lUByu = function (_Component) {
  _inherits(lUByu, _Component);

  function lUByu() {
    _classCallCheck(this, lUByu);

    return _possibleConstructorReturn(this, (lUByu.__proto__ || Object.getPrototypeOf(lUByu)).apply(this, arguments));
  }
...
_metalSoy2.default.register(lUByu, _headerSoy2.default);

exports.default = lUByu;
