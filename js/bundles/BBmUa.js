...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "BBmUa", function() { return BBmUa; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(0);
...
/**
 * @fileoverview Templates in namespace BBmUa.
 * @public
 */

goog.module('BBmUa.incrementaldom');
...
function $render(opt_data, opt_ignored, opt_ijData) {
  var param786 = function() {
    ie_open('article', null, null,
      ...
      ie_open('div', null, null,
        ...
        ie_open('h4', null, null,
          ...
          itext('Section Header');
        ie_close('h4');
        ie_open('div', null, null,
            'class', 'form-group');
          ie_open('label', null, null,
              'for', 'basicInputTypeText');
            itext('Text');
            ie_open('span', null, null,
        ...
        ie_open('div', null, null,
            'class', 'form-group');
          ie_open('label', null, null,
              'for', 'basicInputTypeUrl');
            itext('Url');
          ie_close('label');
          ie_open('input', null, null,
              'class', 'form-control',
              'id', 'basicInputTypeUrl',
              'type', 'url');
          ie_close('input');
        ie_close('div');
        ie_open('div', null, null,
            'class', 'form-group');
          ie_open('label', null, null,
              'for', 'basicInputTypeTel');
            itext('Tel');
          ie_close('label');
          ie_open('input', null, null,
              'class', 'form-control',
              'id', 'basicInputTypeTel',
              'type', 'tel');
          ie_close('input');
        ie_close('div');
        ie_open('div', null, null,
        ...
        ie_open('div', null, null,
            'class', 'form-group');
          ie_open('label', null, null,
              'for', 'basicInputTypeSearch');
            itext('Search');
          ie_close('label');
          ie_open('input', null, null,
              'class', 'form-control',
              'id', 'basicInputTypeSearch',
              'type', 'search');
          ie_close('input');
        ie_close('div');
        ie_open('div', null, null,
            'class', 'form-group');
          ie_open('label', null, null,
              'for', 'basicInputTypeNumber');
            itext('Number');
          ie_close('label');
          ie_open('input', null, null,
              'class', 'form-control',
              'id', 'basicInputTypeNumber',
              'type', 'number');
          ie_close('input');
        ie_close('div');
        ie_open('div', null, null,
            'class', 'form-group');
          ie_open('label', null, null,
              'for', 'basicInputTypeRange');
            itext('Range');
          ie_close('label');
          ie_open('input', null, null,
              'class', 'form-control',
              'id', 'basicInputTypeRange',
              'type', 'range');
          ie_close('input');
        ie_close('div');
      ie_close('div');
    ...
    ie_open('article', null, null,
      ...
      ie_open('div', null, null,
          'class', 'sheet');
        ie_open('div', null, null,
            'class', 'form-group form-inline-autofit');
          ie_open('div', null, null,
        ...
        ie_close('div');
        ie_open('div', null, null,
            'class', 'align-items-end form-group form-inline-autofit');
          ie_open('div', null, null,
              'class', 'form-inline-group');
            ie_open('label', null, null,
  ...
  $templateAlias1(soy.$$assignDefaults({content: param786}, opt_data), null, opt_ijData);
}
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'BBmUa.render';
}
...
class BBmUa extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(BBmUa, templates);
...
var _form_elementsSoy = __webpack_require__(95);
...
var BBmUa = function (_Component) {
  _inherits(BBmUa, _Component);

  function BBmUa() {
    _classCallCheck(this, BBmUa);

    return _possibleConstructorReturn(this, (BBmUa.__proto__ || Object.getPrototypeOf(BBmUa)).apply(this, arguments));
  }
...
_metalSoy2.default.register(BBmUa, _form_elementsSoy2.default);

exports.default = BBmUa;
