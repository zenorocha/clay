var pageComponent =
webpackJsonppageComponent([13,39,40],[
/* 0 */,
/* 1 */,
/* 2 */,
/* 3 */,
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ApbwM", function() { return ApbwM; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(0);
...
/**
 * @fileoverview Templates in namespace ApbwM.
 * @public
 */

goog.module('ApbwM.incrementaldom');
...
function $render(opt_data, opt_ignored, opt_ijData) {
  var param1453 = function() {
    ...
    ie_open('article', null, null,
        'id', 'clay-navbar-navigation-bar');
      ie_open('h3');
        itext('DEFAULT');
      ie_close('h3');
      ie_open('blockquote');
        ie_open('p');
          itext('Positive navigation bar is defined for Sites.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('p');
        ie_open('nav', null, null,
            ...
            ie_open('div', null, null,
              ...
              ie_open('div', null, null,
                ...
                ie_open('ul', null, null,
                  ...
                  ie_close('li');
                  ie_open('li', null, null,
                      'class', 'dropdown nav-item show-dropdown-on-collapse');
                    ie_open('a', null, null,
                        'aria-expanded', 'false',
                        'aria-haspopup', 'true',
    ...
    ie_open('article', null, null,
      ...
      ie_open('blockquote');
        ie_open('p');
          itext('Negative navigation bar is defined for Admin. It is always placed right below the header.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('p');
        ie_open('nav', null, null,
      ...
      $templateAlias2({code: '{call ClayNavbar.render}\n    {param inverted: true /}\n    {param items: [\n        [\n            \'title\': \'App Section 1\',\n            \'url\': \'#1\'\n        ],\n        [\n            \'active\'; true,\n            \'title\': \'App Section 2\',\n            \'url\': \'#1\'\n        ],\n        [\n            \'title\': \'App Section 3\',\n            \'url\': \'#1\'\n        ],\n        [\n            \'title\': \'App Section 4\',\n            \'url\': \'#1\'\n        ],\n        [\n            \'title\': \'App Section 5\',\n            \'url\': \'#1\'\n        ],\n        [\n            \'title\': \'App Section 6\',\n            \'url\': \'#1\'\n        ],\n        [\n            \'title\': \'App Section 7\',\n            \'url\': \'#1\'\n        ]\n    ] /}\n    {param spritemap: \'/vendor/lexicon/icons.svg\' /}\n{/call}', mode: 'soy'}, null, opt_ijData);
      $templateAlias2({code: '<clay-navbar\n    inverted="true"\n    items=\'[\n        {"title": "App Section 1", "url": "#1"},\n        {"title": "App Section 2", "url": "#1"},\n        {"title": "App Section 3", "url": "#1"},\n        {"title": "App Section 4", "url": "#1"},\n        {"title": "App Section 5", "url": "#1"},\n        {"title": "App Section 6", "url": "#1"},\n        {"title": "App Section 7", "url": "#1"}\n    ]\'\n    spritemap="/vendor/lexicon/icons.svg">\n</clay-navbar>', mode: 'text/html'}, null, opt_ijData);
      $templateAlias2({code: '<nav class="navbar navbar-collapse-absolute navbar-expand-md navbar-underline navigation-bar navigation-bar-secondary">\n    <div class="container">\n        <a aria-controls="navigationBarCollapse00" aria-expanded="false" aria-label="Toggle Navigation" class="collapsed navbar-toggler navbar-toggler-link" data-toggle="collapse" href="#navigationBarCollapse00" role="button">\n            <span class="navbar-text-truncate">App Section 2</span>\n            <svg aria-hidden="true" class="lexicon-icon lexicon-icon-caret-bottom">\n                <use xlink:href="/vendor/lexicon/icons.svg#caret-bottom" />\n            </svg>\n        </a>\n        <div class="collapse navbar-collapse" id="navigationBarCollapse00">\n            <div class="container">\n                <ul class="navbar-nav">\n                    <li class="nav-item">\n                        <a class="nav-link" href="#1">\n                            <span class="navbar-text-truncate">App Section 1</span>\n                        </a>\n                    </li>\n                    <li aria-label="Current Page" class="nav-item">\n                        <a class="active nav-link" href="#1">\n                            <span class="navbar-text-truncate">App Section 2</span>\n                        </a>\n                    </li>\n                    <li class="nav-item">\n                        <a class="nav-link" href="#1">\n                            <span class="navbar-text-truncate">App Section 3</span>\n                        </a>\n                    </li>\n                    <li class="dropdown nav-item show-dropdown-on-collapse">\n                        <a aria-expanded="false" aria-haspopup="true" class="dropdown-toggle nav-link" data-toggle="dropdown" href="#1" role="button">\n                            <span class="navbar-text-truncate">More</span>\n                            <svg aria-hidden="true" class="lexicon-icon lexicon-icon-caret-bottom">\n                                <use xlink:href="/vendor/lexicon/icons.svg#caret-bottom" />\n                            </svg>\n                        </a>\n                        <div aria-labelledby="" class="dropdown-menu">\n                            <a class="dropdown-item" href="#1">App Section 4</a>\n                            <a class="dropdown-item" href="#1">App Section 5</a>\n                            <a class="dropdown-item" href="#1">App Section 6</a>\n                            <a class="dropdown-item" href="#1">App Section 7</a>\n                        </div>\n                    </li>\n                </ul>\n            </div>\n        </div>\n    </div>\n</nav>', mode: 'text/html'}, null, opt_ijData);
    ie_close('article');
  ...
  $templateAlias1(soy.$$assignDefaults({content: param1453}, opt_data), null, opt_ijData);
}
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'ApbwM.render';
}
...
class ApbwM extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(ApbwM, templates);
...
var _navbarSoy = __webpack_require__(117);

var _navbarSoy2 = _interopRequireDefault(_navbarSoy);
...
var ApbwM = function (_Component) {
  _inherits(ApbwM, _Component);

  function ApbwM() {
    _classCallCheck(this, ApbwM);

    return _possibleConstructorReturn(this, (ApbwM.__proto__ || Object.getPrototypeOf(ApbwM)).apply(this, arguments));
  }
...
_metalSoy2.default.register(ApbwM, _navbarSoy2.default);

exports.default = ApbwM;
