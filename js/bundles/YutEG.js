...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "YutEG", function() { return YutEG; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(0);
...
/**
 * @fileoverview Templates in namespace YutEG.
 * @public
 */

goog.module('YutEG.incrementaldom');
...
function $render(opt_data, opt_ignored, opt_ijData) {
  var param187 = function() {
    ...
    ie_open('article', null, null,
      ...
      ie_open('blockquote');
        ie_open('p');
          itext('This type of alert is specific for toast messages. This type of messages appear on the top right corner of the screen. The maximum width of a toast message is 360px and the height can vary depending on the number of rows. It always have a close action.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('div', null, null,
          'id', 'claySiteAlertsNotificationsSpacer');
        ie_open('div', null, null,
            'class', 'row');
          ie_open('div', null, null,
              'class', 'col-6');
            ie_open('div', null, null,
              ...
              ie_open('div', null, null,
                  'class', 'alert-notifications alert-notifications-absolute');
                ie_open('div', null, null,
                  ...
                  ie_open('strong', null, null,
                    ...
                    itext('Error:');
                  ie_close('strong');
                  itext(' This is an error message');
                  ie_open('button', null, null,
                      'aria-label', 'Close',
                      'class', 'close',
                      'data-dismiss', 'alert',
        ...
        ie_close('div');
      ie_close('div');
      $templateAlias2({code: '<div class="alert-container container">\n    <div class="alert-notifications alert-notifications-absolute">\n        <div class="alert alert-dismissible alert-danger" role="alert">\n            ...\n        </div>\n    </div>\n</div>', mode: 'text/html'}, null, opt_ijData);
    ie_close('article');
    ie_open('article', null, null,
        'id', 'clay-alert-embedded');
      ie_open('h3');
        itext('EMBEDDED');
      ie_close('h3');
      ie_open('blockquote');
        ie_open('p');
          itext('Embedded alerts are thought to be used inside context as forms. Usually you will only need to use the information one. Its width depends on the container with you use it, always respecting the container margins to the content. The close action is not of mandatory use.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('div', null, null,
    ...
    ie_open('article', null, null,
      ...
      ie_close('blockquote');
      ie_open('div', null, null,
          'class', 'alert alert-danger alert-dismissible alert-fluid',
          'role', 'alert');
        ie_open('div', null, null,
            'class', 'container');
          ie_open('span', null, null,
      ...
      ie_close('div');
      ie_open('div', null, null,
          'class', 'alert alert-dismissible alert-fluid alert-success',
          'role', 'alert');
        ie_open('div', null, null,
            'class', 'container');
          ie_open('span', null, null,
      ...
      ie_close('div');
      ie_open('div', null, null,
          'class', 'alert alert-dismissible alert-fluid alert-info',
          'role', 'alert');
        ie_open('div', null, null,
            'class', 'container');
          ie_open('span', null, null,
      ...
      ie_close('div');
      ie_open('div', null, null,
          'class', 'alert alert-dismissible alert-fluid alert-warning',
          'role', 'alert');
        ie_open('div', null, null,
            'class', 'container');
          ie_open('span', null, null,
    ...
    ie_open('article', null, null,
      ...
      ie_open('div', null, null,
        ...
        ie_open('strong', null, null,
          ...
          itext('Success:');
        ie_close('strong');
        itext(' This is a success closeable alert');
        ie_open('button', null, null,
            'aria-label', 'Close',
            'class', 'close',
            'data-dismiss', 'alert',
      ...
      $templateAlias2({code: '<div class="alert alert-dismissible alert-success" role="alert">\n    <span class="alert-indicator">\n        <svg aria-hidden="true" class="lexicon-icon lexicon-icon-check-circle-full">\n            <use xlink:href="/vendor/lexicon/icons.svg#check-circle-full"></use>\n        </svg>\n    </span>\n    <strong class="lead">Success:</strong> This is a success closeable alert\n    <button aria-label="Close" class="close" data-dismiss="alert" type="button">\n        <svg aria-hidden="true" class="lexicon-icon lexicon-icon-times">\n            <use xlink:href="/vendor/lexicon/icons.svg#times" />\n        </svg>\n    </button>\n</div>', mode: 'text/html'}, null, opt_ijData);
    ie_close('article');
    ie_open('article', null, null,
        'id', 'clay-alert-notifications-fixed');
      ie_open('h4');
        itext('Fixed Notifications');
      ie_close('h4');
      ie_open('blockquote');
        ie_open('p');
          itext('A fixed positioned container for placing alerts on the top right corner of the page. This component can generally be placed anywhere on the page.');
        ie_close('p');
      ie_close('blockquote');
      $templateAlias2({code: '<div class="alert-notifications alert-notifications-fixed">\n    <div class="alert alert-dismissible alert-info alert-notification" role="alert">\n        ...\n    </div>\n</div>', mode: 'text/html'}, null, opt_ijData);
    ie_close('article');
...
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'YutEG.render';
}
...
class YutEG extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(YutEG, templates);
...
var _alertsSoy = __webpack_require__(87);
...
var YutEG = function (_Component) {
  _inherits(YutEG, _Component);

  function YutEG() {
    _classCallCheck(this, YutEG);

    return _possibleConstructorReturn(this, (YutEG.__proto__ || Object.getPrototypeOf(YutEG)).apply(this, arguments));
  }
...
_metalSoy2.default.register(YutEG, _alertsSoy2.default);

exports.default = YutEG;
