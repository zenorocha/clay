var pageComponent =
webpackJsonppageComponent([19,39,40],[
/* 0 */,
/* 1 */,
/* 2 */,
/* 3 */,
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "OYvGu", function() { return OYvGu; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(0);
...
// This file was automatically generated from menubar.soy.
// Please don't edit this file by hand.

/**
 * @fileoverview Templates in namespace OYvGu.
 * @public
 */

goog.module('OYvGu.incrementaldom');
 ...
 */
function $render(opt_data, opt_ignored, opt_ijData) {
  var param1221 = function() {
    ie_open('article', null, null,
        'id', 'menubar-vertical-expand-md');
      ie_open('h3');
        itext('Menubar Vertical Expand Md');
      ie_close('h3');
      ie_open('div', null, null,
          'class', 'clay-site-row-spacer row');
        ie_open('div', null, null,
            'class', 'col-md-6');
          ie_open('nav', null, null,
            ...
            ie_open('div', null, null,
                ...
                'id', 'menubarVerticalCollapse01');
              ie_open('ul', null, null,
                  'class', 'nav nav-nested');
                ie_open('li', null, null,
                    'class', 'nav-item');
                  ie_open('a', null, null,
                      'aria-controls', 'menubarVerticalNestedCollapse01',
                      'aria-expanded', 'true',
                      'class', 'collapse-icon nav-link',
                      'data-toggle', 'collapse',
                      'href', '#menubarVerticalNestedCollapse01',
                      'role', 'button');
                    ...
                    ie_open('span', null, null,
                      ...
                      ie_open('svg', null, null,
                        ...
                        ie_void('use', null, null,
                            'xlink:href', '/vendor/lexicon/icons.svg#caret-right');
                      ie_close('svg');
                    ie_close('span');
                    ie_open('span', null, null,
                  ...
                  ie_open('div', null, null,
                      'class', 'collapse show',
                      'id', 'menubarVerticalNestedCollapse01');
                    ie_open('ul', null, null,
                      ...
                      ie_open('li', null, null,
                          'class', 'nav-item');
                        ie_open('a', null, null,
                            'aria-controls', 'menubarVerticalNestedCollapse02',
                            'aria-expanded', 'false',
                            'class', 'collapsed collapse-icon nav-link',
                            'data-toggle', 'collapse',
                            'href', '#menubarVerticalNestedCollapse02',
                            'role', 'button');
                        ...
                        ie_open('div', null, null,
                            'class', 'collapse',
                            'id', 'menubarVerticalNestedCollapse02');
                          ie_open('ul', null, null,
                              'class', 'nav nav-stacked');
                            ie_open('li', null, null,
                                'class', 'nav-item');
                ...
                ie_open('li', null, null,
                    'class', 'nav-item');
                  ie_open('a', null, null,
                      'aria-controls', 'menubarVerticalNestedCollapse03',
                      'aria-expanded', 'false',
                      'class', 'collapsed collapse-icon nav-link',
                      'data-toggle', 'collapse',
                      'href', '#menubarVerticalNestedCollapse03',
                      'role', 'button');
                    itext('SEO');
                    ie_open('span', null, null,
                        'class', 'collapse-icon-closed');
                  ...
                  ie_open('div', null, null,
                      'class', 'collapse',
                      'id', 'menubarVerticalNestedCollapse03');
                    ie_open('ul', null, null,
                        'class', 'nav nav-stacked');
                      ie_open('li', null, null,
                          'class', 'nav-item');
                ...
                ie_open('li', null, null,
                    'class', 'nav-item');
                  ie_open('a', null, null,
                      'aria-controls', 'menubarVerticalNestedCollapse04',
                      'aria-expanded', 'false',
                      'class', 'collapsed collapse-icon nav-link',
                      'data-toggle', 'collapse',
                      'href', '#menubarVerticalNestedCollapse04',
                      'role', 'button');
                    itext('Advanced');
                    ie_open('span', null, null,
                        'class', 'collapse-icon-closed');
                  ...
                  ie_open('div', null, null,
                      'class', 'collapse',
                      'id', 'menubarVerticalNestedCollapse04');
                    ie_open('ul', null, null,
                        'class', 'nav nav-stacked');
                      ie_open('li', null, null,
                          'class', 'nav-item');
  ...
  $templateAlias1(soy.$$assignDefaults({content: param1221}, opt_data), null, opt_ijData);
}
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'OYvGu.render';
}
...
class OYvGu extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(OYvGu, templates);
...
var _menubarSoy = __webpack_require__(111);

var _menubarSoy2 = _interopRequireDefault(_menubarSoy);
...
var OYvGu = function (_Component) {
  _inherits(OYvGu, _Component);

  function OYvGu() {
    _classCallCheck(this, OYvGu);

    return _possibleConstructorReturn(this, (OYvGu.__proto__ || Object.getPrototypeOf(OYvGu)).apply(this, arguments));
  }
...
_metalSoy2.default.register(OYvGu, _menubarSoy2.default);

exports.default = OYvGu;
