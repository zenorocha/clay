...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "dcEFT", function() { return dcEFT; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(0);
...
/**
 * @fileoverview Templates in namespace dcEFT.
 * @public
 */

goog.module('dcEFT.incrementaldom');
...
function $render(opt_data, opt_ignored, opt_ijData) {
  var param1038 = function() {
    ...
    ie_open('article', null, null,
      ...
      $templateAlias2({code: '<clay-label label="Label text"></clay-label>\n\n<clay-label label="Status" style="info"></clay-label>\n\n<clay-label label="Pending" style="warning"></clay-label>\n\n<clay-label label="Rejected" style="danger"></clay-label>\n\n<clay-label label="Approved" style="success"></clay-label>', mode: 'text/html'}, null, opt_ijData);
      $templateAlias2({code: '<span class="label label-secondary">Label Text</span>\n<span class="label label-info">Status</span>\n<span class="label label-warning">Pending</span>\n<span class="label label-danger">Rejected</span>\n<span class="label label-success">Approved</span>', mode: 'text/html'}, null, opt_ijData);
    ie_close('article');
    ie_open('article', null, null,
        'id', 'clay-labels-size');
      ie_open('h3');
      ...
      ie_open('blockquote');
        ie_open('p');
          ...
          ie_open('code');
            itext('label-lg');
          ie_close('code');
          itext(' to make the label larger or use the mixin ');
          ie_open('code');
            itext('label-size($sassMap)');
          ie_close('code');
          itext(' to create a custom sized label.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('p');
        ie_open('span', null, null,
      ...
      $templateAlias2({code: '<clay-label label="Normal Label"></clay-label>\n\n<clay-label label="Large Label" size="lg"></clay-label>', mode: 'text/html'}, null, opt_ijData);
      $templateAlias2({code: '<span class="label label-secondary">Normal Label</span>\n<span class="label label-lg label-secondary">Large Label</span>', mode: 'text/html'}, null, opt_ijData);
    ie_close('article');
    ie_open('article', null, null,
        'id', 'clay-labels-variations');
      ie_open('h3');
        itext('Variations');
      ie_close('h3');
      ie_open('h4');
      ...
      ie_open('blockquote');
        ie_open('p');
          itext('Used to identify, tag content, show status, to filter content or even to provide navigation to elements of same identification. It can be used with status colors.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('p');
        ie_open('span', null, null,
      ...
      ie_close('p');
      $templateAlias2({code: '{call ClayLabel.render}\n    {param label: \'Label Text\' /}\n{/call}', mode: 'soy'}, null, opt_ijData);
      $templateAlias2({code: '<clay-label label="Normal Label"></clay-label>', mode: 'text/html'}, null, opt_ijData);
      $templateAlias2({code: '<span class="label label-secondary">Label Text</span>', mode: 'text/html'}, null, opt_ijData);
      ie_open('h4');
        itext('Label removable');
      ie_close('h4');
      ie_open('blockquote');
        ie_open('p');
          itext('Used in filter bars, categories, etc. Always in default size and without status color. Use it only in default size.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('p');
        ie_open('span', null, null,
      ...
      $templateAlias2({code: '<clay-label closeable="true" label="Label Text"></clay-label>', mode: 'text/html'}, null, opt_ijData);
      $templateAlias2({code: '<span class="label label-dismissible label-secondary">\n    Label Text{sp}\n    <button aria-label="Close" class="btn close btn-unstyled" type="button">\n        <svg aria-hidden="true" class="lexicon-icon lexicon-icon-times">\n            <use xlink:href="/vendor/lexicon/icons.svg#times"></use>\n        </svg>\n    </button>\n</span>', mode: 'text/html'}, null, opt_ijData);
      ie_open('h4');
        itext('Label with link');
      ie_close('h4');
      ie_open('blockquote');
        ie_open('p');
          itext('Used in sites to link to related content.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('p');
        ie_open('a', null, null,
      ...
      ie_close('p');
      $templateAlias2({code: '{call ClayLabel.render}\n    {param href: \'#1\' /}\n    {param label: \'Label Text\' /}\n{/call}', mode: 'soy'}, null, opt_ijData);
      $templateAlias2({code: '<clay-label href="#1" label="Label Text"></clay-label>', mode: 'text/html'}, null, opt_ijData);
      $templateAlias2({code: '<a class="label label-primary" href="#1">Label Text</a>', mode: 'text/html'}, null, opt_ijData);
    ie_close('article');
  ...
  $templateAlias1(soy.$$assignDefaults({content: param1038}, opt_data), null, opt_ijData);
}
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'dcEFT.render';
}
...
class dcEFT extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(dcEFT, templates);
...
var _labelsSoy = __webpack_require__(101);

var _labelsSoy2 = _interopRequireDefault(_labelsSoy);
...
var dcEFT = function (_Component) {
  _inherits(dcEFT, _Component);

  function dcEFT() {
    _classCallCheck(this, dcEFT);

    return _possibleConstructorReturn(this, (dcEFT.__proto__ || Object.getPrototypeOf(dcEFT)).apply(this, arguments));
  }
...
_metalSoy2.default.register(dcEFT, _labelsSoy2.default);

exports.default = dcEFT;
