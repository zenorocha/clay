...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "fGnjl", function() { return fGnjl; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(0);
...
// This file was automatically generated from stickers.soy.
// Please don't edit this file by hand.

/**
 * @fileoverview Templates in namespace fGnjl.
 * @public
 */

goog.module('fGnjl.incrementaldom');
...
function $render(opt_data, opt_ignored, opt_ijData) {
  var param1580 = function() {
    ...
    ie_open('article', null, null,
        'id', 'clay-sticker-sizes');
      ie_open('h3');
        itext('Sizes');
      ie_close('h3');
      ie_open('blockquote');
        ie_open('p');
          itext('Stickers come in 4 sizes sm, normal, lg, and xl . Create your own custom size with the ');
          ie_open('code');
            itext('sticker-size');
          ie_close('code');
          itext(' mixin.');
    ...
    ie_open('article', null, null,
      ...
      ie_open('blockquote');
        ie_open('p');
          itext('Use it only with files and folders. You can place up to 3 characters inside it or an icon. Always capital letters.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('p');
        ie_open('span', null, null,
      ...
      $templateAlias2({code: '<span class="sticker sticker-primary">JPG</span>\n<span class="sticker sticker-primary">\n    <svg aria-hidden="true" class="lexicon-icon lexicon-icon-picture">\n        <use xlink:href="/vendor/lexicon/icons.svg#picture" />\n    </svg>\n</span>', mode: 'text/html'}, null, opt_ijData);
      ie_open('h3');
        itext('Round');
      ie_close('h3');
      ie_open('blockquote');
        ie_open('p');
          itext('Use it only with people. You can places up to 2 characters inside it or an image. Always capital letters.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('p');
        ie_open('span', null, null,
            'class', 'sticker sticker-primary rounded-circle');
          itext('JP');
        ie_close('span');
        itext(' ');
        ie_open('span', null, null,
      ...
      $templateAlias2({code: '<span class="sticker sticker-primary rounded-circle">JP</span>\n<span class="sticker sticker-primary rounded-circle">\n    <span class="sticker-overlay">\n        <img alt="thumbnail" class="img-fluid" src="/images/thumbnail_coffee.jpg">\n    </span>\n</span>', mode: 'text/html'}, null, opt_ijData);
    ie_close('article');
    ie_open('article', null, null,
        'id', 'clay-sticker-position');
      ie_open('h3');
        itext('Position');
      ie_close('h3');
      ie_open('blockquote');
        ie_open('p');
          itext('A sticker can be placed in a Image Card. Its position is always bottom left as you can see in the following example.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('blockquote');
        ie_open('p');
      ...
      ie_open('div', null, null,
        ...
        ie_open('div', null, null,
          ...
          ie_open('div', null, null,
              'class', 'clay-site-positional-sticker');
            ie_open('div', null, null,
                'class', 'aspect-ratio');
              ie_open('img', null, null,
                  'alt', 'thumbnail',
  ...
  $templateAlias1(soy.$$assignDefaults({content: param1580}, opt_data), null, opt_ijData);
}
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'fGnjl.render';
}
...
class fGnjl extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(fGnjl, templates);
...
var _stickersSoy = __webpack_require__(116);

var _stickersSoy2 = _interopRequireDefault(_stickersSoy);
...
var fGnjl = function (_Component) {
  _inherits(fGnjl, _Component);

  function fGnjl() {
    _classCallCheck(this, fGnjl);

    return _possibleConstructorReturn(this, (fGnjl.__proto__ || Object.getPrototypeOf(fGnjl)).apply(this, arguments));
  }
...
_metalSoy2.default.register(fGnjl, _stickersSoy2.default);

exports.default = fGnjl;
