...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "mfcsf", function() { return mfcsf; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(0);
...
/**
 * @fileoverview Templates in namespace mfcsf.
 * @public
 */

goog.module('mfcsf.incrementaldom');
...
function $render(opt_data, opt_ignored, opt_ijData) {
  var param366 = function() {
    ...
    ie_open('div', null, null,
      ...
      itext(' ');
      ie_open('a', null, null,
          'href', 'https://lexicondesign.io/docs/patterns/' + opt_data.page.pattern + '.html');
        var dyn15 = opt_data.page.title;
        if (typeof dyn15 == 'function') dyn15(); else if (dyn15 != null) itext(dyn15);
        itext(' Pattern');
      ie_close('a');
      itext(' for a more in-depth look at the motivations and proper usage of this component.');
    ie_close('div');
    ...
    ie_open('article', null, null,
      ...
      ie_close('button');
      $templateAlias2({code: '{call ClayButton.render}\n    {param label: \'Small\' /}\n    {param size: \'sm\' /}\n{/call}\n\n{call ClayButton.render}\n    {param label: \'Default\' /}\n{/call}', mode: 'soy'}, null, opt_ijData);
      $templateAlias2({code: '<clay-button label="Small" size="sm"></clay-button>\n\n<clay-button label="Default"></clay-button>', mode: 'text/html'}, null, opt_ijData);
      $templateAlias2({code: '<button class="btn btn-secondary btn-sm" type="button">Small</button>\n\n<button class="btn btn-secondary" type="button">Default</button>', mode: 'text/html'}, null, opt_ijData);
    ie_close('article');
    ie_open('article', null, null,
        'id', 'clay-button-sizes');
      ie_open('h3');
      ...
      ie_open('blockquote');
        ie_open('p');
          itext('Buttons can icons instead of text and for that icons need to be monospaced inside the button. Lexicon do not use buttons with text and icon, or text and loading indicator. Icon buttons are used intensively in management bars. This button variation can be primary, secondary or borderless type.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('button', null, null,
          'class', 'btn btn-monospaced btn-primary',
      ...
      ie_close('button');
      $templateAlias2({code: '{call ClayButton.render}\n    {param icon: \'blogs\' /}\n    {param monospaced: true /}\n    {param spritemap: \'/vendor/lexicon/icons.svg\' /}\n{/call}\n\n{call ClayButton.render}\n    {param icon: \'blogs\' /}\n    {param monospaced: true /}\n    {param spritemap: \'/vendor/lexicon/icons.svg\' /}\n    {param style: \'secondary\' /}\n{/call}', mode: 'soy'}, null, opt_ijData);
      $templateAlias2({code: '<clay-button icon="blogs" monospaced="true" spritemap="/vendor/lexicon/icons.svg"></clay-button>\n\n<clay-button icon="blogs" monospaced="true" spritemap="/vendor/lexicon/icons.svg" style="secondary"></clay-button>', mode: 'text/html'}, null, opt_ijData);
      $templateAlias2({code: '<button class="btn btn-monospaced btn-primary" type="button">\n    <svg aria-hidden="true" class="lexicon-icon lexicon-icon-blogs">\n        <use xlink:href="/vendor/lexicon/icons.svg#blogs"></use>\n    </svg>\n</button>\n<button class="btn btn-monospaced btn-secondary" type="button">\n    <svg aria-hidden="true" class="lexicon-icon lexicon-icon-blogs">\n        <use xlink:href="/vendor/lexicon/icons.svg#blogs"></use>\n    </svg>\n</button>', mode: 'text/html'}, null, opt_ijData);
      ie_open('h4');
        itext('Icon and text button');
      ie_close('h4');
      ie_open('blockquote');
        ie_open('p');
          itext('This button type is used only in sites and not in administration. The icon emphasizes and helps to understand the action. The label must be the same icon purpose.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('button', null, null,
          'class', 'btn btn-secondary',
      ...
      ie_close('button');
      $templateAlias2({code: '{call ClayButton.render}\n    {param label: \'Share\' /}\n    {param icon: \'share\' /}\n    {param spritemap: \'/vendor/lexicon/icons.svg\' /}\n    {param style: \'secondary\' /}\n{/call}', mode: 'soy'}, null, opt_ijData);
      $templateAlias2({code: '<clay-button\n    label="share"\n    icon="share"\n    spritemap="/vendor/lexicon/icons.svg"\n    style="secondary">\n</clay-button>', mode: 'text/html'}, null, opt_ijData);
      $templateAlias2({code: '<button class="btn btn-secondary" type="button">\n    <svg aria-hidden="true" class="lexicon-icon lexicon-icon-blogs">\n        <use xlink:href="/vendor/lexicon/icons.svg#share"></use>\n    </svg>\n    Share\n</button>', mode: 'text/html'}, null, opt_ijData);
      ie_open('h4');
      ...
      $templateAlias2({code: '<clay-button block="true" label="Small Block Level Button" size="sm"></clay-button>\n\n<clay-button block="true" label="Normal Block Level Button"></clay-button>', mode: 'text/html'}, null, opt_ijData);
      $templateAlias2({code: '<button class="btn btn-block btn-secondary btn-sm" type="button">Small Block Level Button</button>\n\n<button class="btn btn-block btn-secondary" type="button">Normal Block Level Button</button>', mode: 'text/html'}, null, opt_ijData);
      ie_open('h4');
        itext('Dropdown button');
      ie_close('h4');
      ie_open('blockquote');
        ie_open('p');
          itext('Dropdown buttons are always used together with a dropdown menu. This button variation can be secondary or borderless type.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('div', null, null,
          'class', 'btn-group');
      ...
      ie_open('blockquote');
        ie_open('p');
          itext('Normally placed in toolbars, allows to have adding actions over a dataset. The kind of elements to add with this button are of the same nature and folders. Sometimes it only has a unique action, some others it has more. Visit Dropdown menu > Sorting actions to know more.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('button', null, null,
          'class', 'btn btn-monospaced btn-sm btn-primary',
          'type', 'button');
        ie_open('svg', null, null,
            'aria-hidden', 'true',
            'class', 'lexicon-icon lexicon-icon-blogs');
      ...
      ie_close('button');
      $templateAlias2({code: '{call ClayButton.render}\n    {param icon: \'plus\' /}\n    {param monospaced: true /}\n    {param size: \'sm\' /}\n    {param spritemap: \'/vendor/lexicon/icons.svg\' /}\n{/call}', mode: 'soy'}, null, opt_ijData);
      $templateAlias2({code: '<clay-button icon="plus" size="sm" monospaced="true" spritemap="/vendor/lexicon/icons.svg"></clay-button>', mode: 'text/html'}, null, opt_ijData);
      $templateAlias2({code: '<button class="btn btn-monospaced btn-sm btn-primary" type="button">\n    <svg aria-hidden="true" class="lexicon-icon lexicon-icon-plus">\n        <use xlink:href="/vendor/lexicon/icons.svg#plus"></use>\n    </svg>\n</button>', mode: 'text/html'}, null, opt_ijData);
      ie_open('h4');
        itext('Action button');
      ie_close('h4');
      ie_open('blockquote');
        ie_open('p');
          itext('It is used when a set of contextual actions are needed over an element or a dataset. This button displays a set of actions inside a dropdown menu. The actions must be sorted in an specific way, please visit Dropdown menu > Sorting actions to know more.');
        ie_close('p');
      ie_close('blockquote');
      ie_open('button', null, null,
      ...
      $templateAlias2({code: '<clay-button icon="ellipsis-v" size="sm" monospaced="true" spritemap="/vendor/lexicon/icons.svg"></clay-button>', mode: 'text/html'}, null, opt_ijData);
...
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'mfcsf.render';
}
...
class mfcsf extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(mfcsf, templates);
...
var _buttonsSoy = __webpack_require__(91);
...
var mfcsf = function (_Component) {
  _inherits(mfcsf, _Component);

  function mfcsf() {
    _classCallCheck(this, mfcsf);

    return _possibleConstructorReturn(this, (mfcsf.__proto__ || Object.getPrototypeOf(mfcsf)).apply(this, arguments));
  }
...
_metalSoy2.default.register(mfcsf, _buttonsSoy2.default);

exports.default = mfcsf;
